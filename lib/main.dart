...
class MyApp extends StatelessWidget {
  ...
  Future <Widget> authenticationCheck (BuildContext context) async {
    ...
    if (jwt != null && userId != null) {
      return await UserRepository().jwtSignIn().then((u){
        ...
        print('Wrong credentials ? ${err.toString()}');
      ...
      home: FutureBuilder <Widget> (
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.hasError){
            log('Error caught on authenticationCheck ${snapshot.error.toString()}');
            return LoadingPage();
          }
          else {
            return LoadingPage();
