...
class Audio {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['AudioDateGiven'] = this.audioDateGiven == null ? null:this.audioDateGiven.toUtc().toIso8601String();
    data['AudioDateAdded'] = this.audioDateAdded == null ? null:this.audioDateAdded.toUtc().toIso8601String();
